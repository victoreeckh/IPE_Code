import math
def get_number_of_solar_panels(south_orientation, flat_roof, width_roof, length_roof, width_panel, length_panel, panel_power,converter_power):
    max_panels_by_power = math.floor((converter_power / 0.6) / panel_power)
    if flat_roof is False:
        ...
        return min(number_of_panels, max_panels_by_power)
